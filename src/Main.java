...
public class WordCounter {
    public static void main(String[] args) {
        ...
        // Tạo một HashMap để lưu trữ từng từ và số lần xuất hiện của nó
        Map<String, Integer> wordCounts = new HashMap<>();

        // Tách các từ từ câu và đếm số lần xuất hiện của từng từ
        String[] words = sentence.split("\\s+");
        for (String word : words) {
            // Chuẩn hóa từ bằng cách loại bỏ dấu câu và chuyển đổi thành chữ thường
            word = word.replaceAll("[^a-zA-ZÀ-Ỹà-ỹ]", "").toLowerCase();

            if (!word.isEmpty()) {
                // Kiểm tra xem từ đã tồn tại trong map chưa, nếu đã tồn tại thì tăng số lần đếm lên 1, nếu chưa thì thêm vào map với số lần đếm là 1
